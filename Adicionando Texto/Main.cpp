...
void init() {
    ...
    headingFont.loadFromFile("Assets/fonts/Hack-Regular.ttf");
    headingText.setFont(headingFont);
    headingText.setString("Tiny Bazooka");
    headingText.setCharacterSize(60);
    headingText.setFillColor(Color::White);
    headingText.setOutlineColor(Color::Black);
    headingText.setOutlineThickness(10);
